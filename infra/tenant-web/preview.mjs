...
Object.assign(process.env, {
  VITE_FIREBASE_PROJECT_ID: 'demo-siskop-tenants', VITE_FIREBASE_API_KEY: 'local-emulator-only',
...
const server = createTenantWeb({ baseDomain: 'koperasi.localhost', apiOrigin: 'http://127.0.0.1:3051',
  secret: 'local-tenant-preview-key-32-characters-only', production: false, staticDir: 'apps/frontend/dist',
