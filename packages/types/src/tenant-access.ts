...
export interface TenantAccessConfig { enabled: boolean; switching: boolean; centralUrl: string }
export interface MembershipInvitationResponse { invitationUrl: string; expiresAt: string }
